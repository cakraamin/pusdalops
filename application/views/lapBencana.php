                  ...
                  <div class="content" >                      
                    <div class="tab_container" >
                          <div id="tab1" class="tab_content"> 
                              <div class="load_page">                                                         
                                <div class="formEl_b">  
                                <form id="validation" action="<?=base_url()?>laporan/<?=$link?>/<?=$kuncine?>/<?=$jenise?>/<?=$bencanane?>/<?=$lokasine?>/<?=$val?>/<?=$waktune?>/<?=$tahune?>/<?=$bulane?>/<?=$tanggale?>/<?=$sort_by?>/<?=$sort_order?>/<?=$page?>" method="POST" enctype="multipart/form-data"> 
                                <fieldset >
                                <legend><?=$ket?> <span class="small s_color">( <?=$jenis?> )</span></legend>                                                                                                             
                                      ...
                                      <div>
                                        <a class="uibutton submit_form" >Update</a><a class="uibutton special"   onClick="goBack()" title="Reset  Form"   >Cancel</a>
                                     </div>
                                     </div>                                     
                                </fieldset>
                                </form>
